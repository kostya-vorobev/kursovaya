...
ALTER TABLE IF EXISTS public."Dokument"
    ADD CONSTRAINT "Relationship47" FOREIGN KEY ("PK_Lichnoe_delo")
    REFERENCES public."Lichnoe_delo" ("PK_Lichnoe_delo") MATCH SIMPLE
    ON UPDATE CASCADE
    ON DELETE RESTRICT;
CREATE INDEX IF NOT EXISTS "IX_Relationship47"
    ON public."Dokument"("PK_Lichnoe_delo");
...
ALTER TABLE IF EXISTS public."Zayavlenie"
    ADD CONSTRAINT "Relationship271" FOREIGN KEY ("Napravlenie")
    REFERENCES public."Spetsialnost" ("PK_Spetsialnost") MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION
    NOT VALID;
